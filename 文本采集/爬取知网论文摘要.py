...
def browser_init(isWait):
    ...
    prefs = {'profile.default_content_settings.popups': 0, 'download.default_directory': '/Users/liusijia/2018/爬虫/data'}
    options.add_experimental_option('prefs', prefs)

    browser = webdriver.Chrome(executable_path='/Applications/Google Chrome.app/Contents/MacOS/chromedriver', chrome_options=options)
    #print(browser)
...
def write_to_file(title,zhaiyao):
    fobj=open('/Users/liusijia/2018/东软实习/爬虫/data/'+title+'.txt','w')
    fobj.write(zhaiyao)
    fobj.close()
